...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 4).'/vendor/api-platform/metadata/Mutator/ResourceResourceMutatorCollection.php';
            include_once \dirname(__DIR__, 4).'/vendor/api-platform/metadata/Mutator/OperationMutatorCollectionInterface.php';
            include_once \dirname(__DIR__, 4).'/vendor/api-platform/metadata/Mutator/OperationResourceMutatorCollection.php';
    ...
    protected static function getApiPlatform_StateProvider_ParameterValidatorService($container)
    {
        ...
        $d = new \ApiPlatform\State\Provider\ReadProvider($b, $c, ($container->privates['logger'] ?? self::getLoggerService($container)));
        ...
        return $container->services['api_platform.state_provider.parameter_validator'] = new \ApiPlatform\Symfony\Validator\State\ParameterValidatorProvider($a, $d);
    }
    ...
    protected static function getApiPlatform_Listener_Request_AddFormatService($container)
    {
        ...
        $b = new \ApiPlatform\State\Provider\ContentNegotiationProvider(NULL, ($container->privates['api_platform.negotiator'] ??= new \Negotiation\Negotiator()), $container->parameters['api_platform.formats'], $container->parameters['api_platform.error_formats']);
        if ($container->has('debug.stopwatch')) {
            $b->setStopwatch(($container->services['debug.stopwatch'] ??= new \Symfony\Component\Stopwatch\Stopwatch(true)));
        }

        return $container->privates['api_platform.listener.request.add_format'] = new \ApiPlatform\Symfony\EventListener\AddFormatListener($b, $a);
    }
    ...
    protected static function getApiPlatform_Listener_Request_DeserializeService($container)
    {
        ...
        $e = new \ApiPlatform\State\Provider\DeserializeProvider(NULL, $a, $b, NULL);
        if ($container->has('debug.stopwatch')) {
            $e->setStopwatch(($container->services['debug.stopwatch'] ??= new \Symfony\Component\Stopwatch\Stopwatch(true)));
        }

        return $container->privates['api_platform.listener.request.deserialize'] = new \ApiPlatform\Symfony\EventListener\DeserializeListener(new \ApiPlatform\Symfony\Security\State\AccessCheckerProvider($e, $c, 'post_denormalize'), $d);
    }
    ...
    protected static function getApiPlatform_Listener_Request_ReadService($container)
    {
        ...
        $f = new \ApiPlatform\State\Provider\ParameterProvider(NULL, new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
        ...
        if ($container->has('debug.stopwatch')) {
            $f->setStopwatch(($container->services['debug.stopwatch'] ??= new \Symfony\Component\Stopwatch\Stopwatch(true)));
        }

        return $container->privates['api_platform.listener.request.read'] = new \ApiPlatform\Symfony\EventListener\ReadListener(new \ApiPlatform\State\Provider\SecurityParameterProvider(new \ApiPlatform\Symfony\Security\State\AccessCheckerProvider(new \ApiPlatform\Symfony\Bundle\SwaggerUi\SwaggerUiProvider($a, $b), $c), $c), $d, $e, $f);
    }
    ...
    {
        return $container->privates['api_platform.openapi.options'] = new \ApiPlatform\OpenApi\Options('Hello API Platform', '', '1.0.0', false, 'oauth2', 'application', '', '', '', [], $container->parameters['api_platform.swagger.api_keys'], NULL, NULL, NULL, NULL, NULL, NULL, true, false, [], [], NULL, NULL, NULL);
    }
    ...
    protected static function getApiPlatform_StateProvider_LocatorService($container)
    {
        return $container->privates['api_platform.state_provider.locator'] = new \ApiPlatform\State\CallableProvider(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\DataProvider\\Exam\\ExamReadStateProcessor' => ['privates', 'App\\DataProvider\\Exam\\ExamReadStateProcessor', 'getExamReadStateProcessorService', true],
            ...
            'App\\DataProvider\\Exam\\ExamReadStateProcessor' => 'App\\DataProvider\\Exam\\ExamReadStateProcessor',
    ...
    protected static function getSerializerService($container)
    {
        ...
        $s = new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($l, $r, $d, $e, new \Symfony\Component\Serializer\Mapping\ClassDiscriminatorFromClassMetadata($l), NULL, $container->parameters['api_platform.serializer.default_context'], $e);
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'doctrine.dbal.connection_factory.types' => [
                'event_status' => [
                    'class' => 'App\\DBAL\\Types\\StatusEnumType',
                ],
                'uuid' => [
