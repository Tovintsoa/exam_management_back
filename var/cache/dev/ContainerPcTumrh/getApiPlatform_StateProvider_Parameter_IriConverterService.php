...
class getApiPlatform_StateProvider_Parameter_IriConverterService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['api_platform.state_provider.parameter.iri_converter'] = new \ApiPlatform\State\ParameterProvider\IriConverterParameterProvider($a, ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
}
